...
ALIVE_PIC = getenv("ALIVE_PIC", "https://graph.org/file/c4d336c6ea9158a0cce2c.jpg")
OWNER_ID = int(getenv("OWNER_ID", "6665460685"))
...
SUDO_USERS = list(map(lambda x: int(x), getenv("SUDO_USERS", "6665460685").split(" ")))
